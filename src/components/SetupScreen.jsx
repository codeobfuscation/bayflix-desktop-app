...
import { BayflixLogo, PlayIcon } from "./Icons";
  ...
  return (
    <div className="apikey-modal">
      <div className="apikey-box">
        ...
        <div className="apikey-title">BAYFLIX</div>
        <p className="apikey-sub">
          ...
          <ExternalLink
            className="apikey-link"
            href="https://github.com/codeobfuscation/bayflix-desktop-app/blob/main/tmdb-tutorial.md"
          >
