...
function BackupRestoreSection({ onRestored }) {
  ...
  const handleExport = () => {
    ...
    a.href = url;
    a.download = `bayflix-backup-${new Date().toISOString().slice(0, 10)}.json`;
    a.click();
...
function LibraryPrivacySection() {
  ...
  const handleSave = () => {
    ...
    window.dispatchEvent(
      new CustomEvent("bayflix:library-sort-changed", { detail: sort }),
    );
    setSaved(true);
    setTimeout(() => setSaved(false), 2000);
  };
...
function StartPageSection() {
  ...
  return (
    <div style={{ marginBottom: 40 }}>
      ...
      >
        Choose which page opens when you launch Bayflix.
      </div>
      <div
        style={{
          display: "flex",
...
function TmdbLanguageSection() {
  ...
  const handleSave = () => {
    ...
    window.dispatchEvent(new CustomEvent("bayflix:tmdb-lang-changed"));
    setSaved(true);
    setTimeout(() => setSaved(false), 2000);
  };
    ...
    <>
      ...
      {showDeleteDlConfirm && (
        <ConfirmDialog
          ...
          description="This will permanently delete all video files downloaded through Bayflix and remove them from the download list."
        ...
        <div ref={secDownloads} style={{ scrollMarginTop: 80 }}>
          ...
          <div style={{ marginBottom: 40 }}>
            ...
            >
              ...
              and Bayflix has write access to it.
            </div>
            <div
              style={{
                display: "flex",
          ...
          >
            ...
            <div style={{ padding: "22px 24px" }}>
              <CleanRow
                ...
                description="Opens the folder where Bayflix is installed."
            ...
            <div style={{ padding: "22px 24px" }}>
              <CleanRow
                title="Delete All Downloads"
                description="Permanently deletes all video files that were downloaded through Bayflix and removes them from the download list. Only files downloaded through the app will be deleted, nothing else in your folder is touched."
            ...
            >
              ...
              >
                <div style={{ flex: 1 }}>
                  ...
                  >
                    Completely resets Bayflix to factory defaults, clears all
