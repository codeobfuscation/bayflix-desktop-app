...
export const storage = {
  ...
  // Remove all bayflix_ keys (used by reset)
  clearAll() {
    try {
...
export async function clearAppCaches() {
  ...
  localStorage.removeItem("bayflix_anilistCache");
  localStorage.removeItem("bayflix_episodeGroupCache");
  localStorage.removeItem("bayflix_aniskipCache");
