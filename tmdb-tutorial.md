...
## 5. Paste It Into Bayflix

Paste the token into the Bayflix setup screen and press **Let's go**. And That's it!

---

## Something not working?

If this guide is outdated or you're running into any issues, please [open an issue](https://github.com/codeobfuscation/bayflix-desktop-app/issues/new) on GitHub.